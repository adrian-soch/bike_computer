...
/*
 * Connect to Polar H10 Heart Rate monitor
 * - Confirm serial number before onnecting
 * - Poll HR
 * 
 */
...
BLEClientCharacteristic serialNum(2A25);
...
void setup()
{
  ...
  Serial.println("Starting HR data collection");
  Serial.println("--------------------------------------\n");
